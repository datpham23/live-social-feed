					...
					React.createElement("div", {className: "well container"}, 
						...
						React.createElement("div", {className: formClasses}, 
								...
								this.state.findFailedMessage.length > 0 ?
									React.createElement("label", {className: "control-label", for: "inputError"}, this.state.findFailedMessage)
								: null, 
							

							React.createElement("input", {ref: "boardID", className: "form-control input-lg", type: "text", placeholder: "Board Id", onKeyUp: this.onEnter})
						), 
						React.createElement("a", {href: "javascript:void(0)", onClick: this.onFindBoard, className: "btn btn-success btn-block"}, "Find Board")
					)
				)
			);
		}
