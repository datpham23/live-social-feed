...
/***/ function(module, exports, __webpack_require__) {
	...
	var userApi = __webpack_require__(255);
	...
	var LandingComponent = React.createClass({displayName: "LandingComponent",
		...
		render:function(){
			...
			return (
				React.createElement("div", {className: "landing-page page"}, 
					React.createElement("div", {className: "well container"}, 
							...
							this.state.userLoggedIn ?
								React.createElement("h3", null, "Hi "+this.getUserName()+"!", " ")
							:
								React.createElement("h3", null, "Sign In To Get Started"), 
						
						React.createElement("hr", null), 
						
							this.state.createFailedMessage.length > 0 ?
								React.createElement("h4", {className: "text-danger"}, this.state.createFailedMessage)
								:
								null, 
						
						
							this.state.userLoggedIn?
								React.createElement("a", {href: "javascript:void(0)", onClick: this.onCreateBoard, className: "btn btn-info btn-block create-button"}, "Create New Board")
							:
								React.createElement("div", null, 
									React.createElement("a", {href: "/auth/instagram?callbackURL=/#/", onClick: this.signInWithInstagram, className: "btn btn-primary btn-block social-signin twitter-signin"}, React.createElement("img", {src: "/img/instagram.png"}), " Instagram"), 
									React.createElement("a", {href: "/auth/twitter?callbackURL=/#/", onClick: this.signInWithTwitter, className: "btn btn-info btn-block social-signin"}, React.createElement("img", {src: "/img/twitter.png"}), " Twitter"), 
									React.createElement("a", {href: "#", onClick: this.signInWithFacebook, className: "btn btn-warning btn-block social-signin"}, React.createElement("img", {src: "/img/facebook.png"}), " Facebook (Under construction)")
								)
