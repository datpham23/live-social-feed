...
/***/ function(module, exports, __webpack_require__) {
	...
	var BoardComponent = React.createClass({displayName: "BoardComponent",
		render:function(){
			return (
				React.createElement("div", {className: "board-page page"}, 
					React.createElement("div", {className: "well container"}, 
						React.createElement(PageHeader, {backLink: "#/"}), 
						React.createElement("h3", {className: "text-primary board-id"}, 
							React.createElement("span", {className: "text-muted"}, "Board ID: "), 
							React.createElement("span", null, this.props.boardId)
						), 

						React.createElement("a", {href: "#/gallery/"+this.props.boardId, className: "btn btn-info btn-block"}, "View Board"), 
						React.createElement("a", {href: "#/postToBoard/"+this.props.boardId, className: "btn btn-success btn-block"}, "Post To Board"), 
						React.createElement("a", {href: "#/configure/"+this.props.boardId, className: "btn btn-primary btn-block"}, "Configure Board")
					)
				)
			);
		}
