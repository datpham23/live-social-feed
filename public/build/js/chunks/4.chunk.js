...
/***/ function(module, exports, __webpack_require__) {
	...
	var TaggedInput = __webpack_require__(25);
	var configurationAPI = __webpack_require__(2);
	var socketManager = __webpack_require__(15);
	var PageHeader = __webpack_require__(16)


	var ConfigurationComponent = React.createClass({displayName: "ConfigurationComponent",
	  ...
	  render:function(){
	    return (
	      React.createElement("div", {className: "configuration-page page"}, 
	        React.createElement("div", {className: "container well"}, 
	          React.createElement(PageHeader, {backLink: "#/board/"+this.props.boardId}), 
	          React.createElement("div", {className: "connection-indicator"}, 
	            
	              this.state.connectionOpened?
	                React.createElement("i", {className: "mdi-device-signal-cellular-4-bar mdi-material-teal"})
	              :
	                React.createElement("span", {className: "text-danger"}, "No Connection To Server ", React.createElement("i", {className: "mdi-device-signal-cellular-connected-no-internet-0-bar  mdi-material-red"}), " ")
	            
	          ), 
	          
	            this.state.errorMessage.length > 0?
	              React.createElement("h3", {className: "text-danger"}, this.state.errorMessage)
	            :
	            React.createElement("div", null, 
	              
	                this.state.configs.instagram.accessToken?
	                    React.createElement("div", {className: "config-group"}, 
	                      React.createElement("img", {className: "social-icon", src: "/img/instagram.png"}), 
	                  ...
	                  React.createElement("div", {className: "signin-container"}, 
	                    React.createElement("a", {href: "/instagram/authorize-user/"+this.props.boardId, className: "btn btn-primary signin-button"}, 
	                      React.createElement("img", {className: "social-icon", src: "/img/instagram.png"}), 
	              ...
	              React.createElement("div", {className: "config-group"}, 
	                React.createElement("img", {className: "social-icon", src: "/img/twitter.png"}), 
	                React.createElement(TaggedInput, {
	                  ref: "twitterTags", 
	                  autofocus: true, 
	                  backspaceDeletesWord: true, 
	              ...
	              React.createElement("div", {className: "config-group"}, 
	                React.createElement("img", {className: "social-icon", src: "/img/facebook.png"}), 
	                React.createElement(TaggedInput, {
	                  ref: "facebookTags", 
	                  autofocus: true, 
	                  backspaceDeletesWord: true, 
	              ...
	              React.createElement("div", {className: "config-group"}, 
	                React.createElement("img", {className: "social-icon", src: "/img/vine.png"}), 
	                React.createElement(TaggedInput, {
	                  ref: "vineTags", 
	                  autofocus: true, 
	                  backspaceDeletesWord: true, 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PageHeader = React.createClass({displayName: "PageHeader",
		render:function(){
			return (
				React.createElement("div", null, 
					React.createElement("a", {href: this.props.backLink, className: "btn btn-link back-button"}, 
						React.createElement("i", {className: "mdi-navigation-chevron-left mdi-material-teal"}), 
